...
export const MyVoiceSkill = () => (
  <VoiceSkill>
    <IntentHandler
      aliases={['AMAZON.StartOverIntent']}
      intent="LaunchRequest"
      state={GAME_STATES.START}
      stateHandler="StartGame"
    />

    <IntentHandler intent="Unhandled">
      <Response>
        <Speak listen="START_UNHANDLED">START_UNHANDLED</Speak>
      </Response>
    </IntentHandler>
  </VoiceSkill>
);

renderToAlexa(<MyVoiceSkill />, {
  appId: APP_ID,
  event,
  context,
